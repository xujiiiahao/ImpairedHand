...
def get_contact_points_wo2(hand_verts, hand_faces, obj_verts):
    finger_vertices = [middlefinger_vertices, fourthfinger_vertices,
                       smallfinger_vertices, bigfinger_vertices]
    forces = []
    torques = []
    normals = []
...
def get_contact_points_wo3(hand_verts, hand_faces, obj_verts):
    finger_vertices = [indexfinger_vertices, fourthfinger_vertices,
                       smallfinger_vertices, bigfinger_vertices]
    forces = []
    torques = []
    normals = []
...
def get_contact_points_wo4(hand_verts, hand_faces, obj_verts):
    finger_vertices = [indexfinger_vertices, middlefinger_vertices,
                       smallfinger_vertices, bigfinger_vertices]
    forces = []
    torques = []
    normals = []
...
def get_contact_points_wo5(hand_verts, hand_faces, obj_verts):
    finger_vertices = [indexfinger_vertices, middlefinger_vertices, fourthfinger_vertices,
                       bigfinger_vertices]
    forces = []
    torques = []
